...
<head>
    <meta charset="utf-8">
    <title>Glamour Glow - Product Detail</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Glamour Glow - Product Detail" name="keywords">
    <meta content="Glamour Glow - Product Detail" name="description">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="product-item">
                                            <div class="product-title">
                                                <a href="#"><?php echo $product['libelle']; ?></a>
                                                <div class="ratting">
                                                        <?php 
