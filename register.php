...
if (isset($_POST['signUp'])) {
    ...
    if (!empty($first_name) && !empty($last_name) && !empty($email) && !empty($mobile_no) && !empty($password)) {
        $sql = $conn->prepare('INSERT INTO Users (first_name, last_name, email, mobile_no, password) VALUES (?, ?, ?, ?, ?)');
        $sql->bind_param('sssss', $first_name, $last_name, $email, $mobile_no, $password);
        $sql->execute();
        ...
        if ($sql->affected_rows > 0) {
            ...
            echo "<div class='alert alert-danger' role='alert'>Échec de l'inscription. Veuillez réessayer.</div>";
        }
    } else {
                    ...
                    <div class="navbar-nav ml-auto">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="user.php" class="dropdown-item">My Account</a>
                        ...
                        <div class="register-form">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="Mobile No" name="mobile_no" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button class="btn" name="signUp">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
